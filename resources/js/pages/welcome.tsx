                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                                Your toolkit for a simpler web experience.
                                <br />
                            ...
                            <div className="space-y-8">
                                <section>
                                    <h2 className="mb-4 font-bold text-gray-900 dark:text-white">🚀 Link Shortener</h2>
                                    <p className="mb-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                                        Create short, custom links in seconds. Perfect for social media, emails, or just keeping things tidy.
                                    </p>
                                    <div className="flex gap-4">
                                        <Link
                                            href={LinkController.create().url}
                                            className="inline-block rounded-xl bg-[#f53003] px-8 py-3 text-sm font-bold text-white shadow-lg shadow-red-500/20 hover:bg-[#e22c02] dark:bg-[#FF4433] dark:shadow-red-900/20 dark:hover:bg-[#f63d2d] transition-all"
                                        >
                                            Shorten a Link Now
                                        </Link>
                                        <Link
                                ...
                                <div className="mt-8 border-t border-[#e3e3e0] pt-8 dark:border-[#3E3E3A]">
                                    ...
                                    <ul className="mb-4 flex flex-col gap-2">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>Read the <a href="https://laravel.com/docs" target="_blank" className="underline underline-offset-4 hover:text-[#f53003] dark:hover:text-[#FF4433]">Documentation</a></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#f53003] dark:bg-[#FF4433]" />
                                            <span>Watch <a href="https://laracasts.com" target="_blank" className="underline underline-offset-4 hover:text-[#f53003] dark:hover:text-[#FF4433]">Laracasts</a></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
