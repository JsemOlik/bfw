...
export default function AdminPastes({
    ...
    function clearSearch(): void {
        ...
        router.get(adminPastesIndex.url(), {}, {
            preserveScroll: true,
            preserveState: true,
            replace: true,
        });
                    ...
                    >
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                placeholder="Search by paste ID, slug, content, file, or owner"
                        ...
                        {pastes.data.length === 0 ? (
                            <div className="px-6 py-14 text-center">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    {filters.search !== ''
                                        ? 'Try a different search and we might find some pastes for you.'
                                        : 'No pastes have been created yet.'}
                                </p>
                            </div>
                        ) : (
