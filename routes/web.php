...
Route::post('paste', [PasteController::class, 'store'])
    ...
    ->name('paste.store');
Route::get('paste/{slug}/download', fn (string $slug) => redirect('/'.$slug.'/download', 301));
...
Route::get('{slugRegistry:slug}/download', [PublicSlugController::class, 'download'])->name('paste.download');
